  ...
  return (
    <section className="lp-solution" id="solution">
      <div className="lp-solution-grid">
        ...
        <div className="lp-solution-tr-card bg-primary text-black">
        ...
        <div className="lp-solution-tr-card bg-black text-white">
        ...
        <div className="lp-solution-tr-card bg-white text-black">
